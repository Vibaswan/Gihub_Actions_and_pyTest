...
tx_port = port.Port(name='Tx Port', location='10.39.35.12;02;13')
rx_port = port.Port(name='Rx Port', location='10.39.35.12;02;14')
...
api = IxNetworkApi(address='10.66.44.243', port=11009)
